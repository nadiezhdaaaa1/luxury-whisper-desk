...
export function InsightsCard({
  ...
  return (
    <section className="rounded-2xl border border-hairline bg-card p-4 sm:p-5 h-[340px] flex flex-col">
          ...
          return (
            <li key={s.id}>
              <Link
                ...
                className="group flex items-center gap-3 py-3.5 -mx-1 px-1 rounded-lg hover:bg-surface-2 transition-colors"
              >
                <span
                  className={cn(
