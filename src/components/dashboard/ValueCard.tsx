...
export function ValueCard({ slice, period, hasItems }: Props) {
  ...
  return (
    <section className="card-flat p-6 sm:p-8 flex flex-col h-full">
      ...
      {hasItems ? (
        <>
          <div className="mt-3 font-display font-bold tracking-tight text-primary text-4xl sm:text-6xl leading-none tabular-nums">
            {fmtUSD(value)}
          </div>
