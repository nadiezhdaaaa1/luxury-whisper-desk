      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-3">
          <div className="flex flex-wrap items-center gap-2 min-w-0">
            <span
              className={`inline-flex border border-hairline px-3 py-1 text-[11px] ${style.bg} ${isWrapped ? "flex-col items-start gap-1 rounded-lg" : "items-center gap-x-2 gap-y-1 rounded-full"}`}
            >
