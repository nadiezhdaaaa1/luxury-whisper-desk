  ...
  return (
    <footer className="bg-surface/70">
      <div className="container-page py-16">
        <div className="grid gap-10 md:grid-cols-2 md:gap-x-10 lg:grid-cols-12 lg:gap-32">
          {/* Logo */}
          ...
          <div className="text-xs text-muted-foreground leading-relaxed md:text-right lg:text-left lg:col-span-4 lg:col-start-1 lg:row-start-2 lg:-mt-2">
