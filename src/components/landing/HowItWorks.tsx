  ...
  return (
    <div className="mt-6 card-soft p-5 max-w-sm h-full relative overflow-hidden">
      ...
      <img
        ...
        className="absolute right-[-24px] bottom-[-60px] h-[248px] w-[102px] object-contain"
      />
    </div>
  );
}
    ...
    <section id="how" className="py-20 lg:py-28 bg-surface/60 border-y border-hairline">
      <div className="container-page">
        ...
        <div className="mt-20 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-9 md:gap-6 lg:gap-8 md:items-stretch">
            {steps.map((s, i) => (
