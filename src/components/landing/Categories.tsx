...
const cats = [
  {
    ...
    brands: "Rolex · Patek Philippe · AP · Omega · Tudor · TAG Heuer · Longines · Grand Seiko · Cartier",
    accent: true,
    image: watchImg.url,
  },
  {
    ...
    brands: "Cartier · Van Cleef & Arpels · Tiffany · Bulgari · David Yurman · Pomellato",
    accent: true,
  ...
  },
  {
    ...
    brands: "Hermès · Chanel · Louis Vuitton · Bottega Veneta · Celine · Loewe",
    image: bagsImg.url,
  },
  {
    title: "Fashion",
