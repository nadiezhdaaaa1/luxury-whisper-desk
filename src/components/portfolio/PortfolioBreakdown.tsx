  ...
  return (
    <section className="card-flat mb-8 p-5 sm:p-6">
      <header className="flex items-center justify-center gap-4">
        <div className="flex w-full items-center rounded-full border border-hairline bg-background p-0.5 text-[11px] font-display font-semibold uppercase tracking-widest">
