// V3 in-app quiz — direct-signup path skips the email gate (already authed).
...
export const Route = createFileRoute("/_authenticated/app/quiz-v3")({
  head: () => ({
    meta: [
      { title: "Quick setup (V3) — PriceYou" },
      { name: "robots", content: "noindex" },
    ],
  }),
  component: InAppQuizV3Page,
});

function InAppQuizV3Page() {
  ...
  async function submit(a: QuizAnswersV3) {
    ...
    try {
      ...
      track("quiz_v3_completed_saved", { mode: "in-app" });
