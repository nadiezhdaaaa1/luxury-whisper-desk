...
export const Route = createFileRoute("/cookies")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How PriceYou uses cookies and similar technologies, what categories we use, and how to manage your choices from the cookie preferences panel." },
